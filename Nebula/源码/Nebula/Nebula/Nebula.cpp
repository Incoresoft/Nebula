// Nebula.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CNebulaApp, CBCGPWinApp)
...
// CNebulaApp construction

CNebulaApp::CNebulaApp()
{
...
// The one and only CNebulaApp object

CNebulaApp theApp;


// CNebulaApp initialization

BOOL CNebulaApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CNebulaDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CNebulaView));
	if (!pDocTemplate)
		return FALSE;
...
// CNebulaApp message handlers

int CNebulaApp::ExitInstance() 
{
